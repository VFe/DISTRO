...
exports = module.exports = {
	init: collectionUtil.init('networks'),
	batchNetworkFromId: function(ids, callback){
	...
	findNetworkByName: function(name, options, callback){
	...
	liveNetworks: function(callback){
		var self = this;
...
exports.Proxy = function(id, key){
	this.id = id;
	this.data = null;
	this.key = key || ['name', 'fullname'];
}

exports.Proxy.prototype.toJSON = function(){
	return this.data;
}

exports.Proxy.prototype.resolve = function(networkDetails){
	if (networkDetails) {
		var self = this;
		function set(key){
...
exports.ProxySet = function(){
	this.proxies = [];
}

exports.ProxySet.prototype.push = function(proxy){
	this.proxies.push(proxy);
}
exports.ProxySet.prototype.create = function(id, key){
	var proxy = new exports.Proxy(id, key);
	this.push(proxy);
	return proxy;
}
exports.ProxySet.prototype.resolve = function(callback){
	...
	exports.batchNetworkFromId(networkIds, function(err, networkMap){
		if (err) {
			callback(err, null);
		} else {
