...
{ "_id" : { "$oid" : "000000000000000000000000" }, "name" : "test_network_1" }
...
{ "_id" : { "$oid" : "4d22380a704f8f211756ca32" }, "name" : "Chez (On deck)", "filename" : "Chez", "release" : { "$date" : 1259625600000 }, "onDeck" : [ { "start" : { "$date" : 1259625600000 } } ], "network" : { "$oid" : "000000000000000000000000" } }
...
{ "_id" : { "$oid" : "4d22380a704f8f211756ca35" }, "name" : "Crafty (Released during first subscription)", "filename" : "Crafty", "release" : { "$date" : 1264982400000 }, "onDeck" : [], "network" : { "$oid" : "000000000000000000000000" } }
...
{ "_id" : { "$oid" : "4d22380a704f8f211756ca37" }, "name" : "Jay-Z (Released during second subscription)", "filename" : "Jay-Z", "release" : { "$date" : 1285891200000 }, "onDeck" : [], "network" : { "$oid" : "000000000000000000000000" } }
EOF
