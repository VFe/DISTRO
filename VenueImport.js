						...
						cursor.nextObject(function(err, doc){
							if(doc != null){
								var myspaceRegEx = new RegExp("/\/(\w+$)/", "g"),
									...
									basicRenameList = [{oldName:"TYPE", newName:"type"}, {oldName:"NETWORK_NAME", newName:"name"}, {oldName:"FULL_NAME", newName:"fullname"}, {oldName:"STREET_ADDRESS", newName:"streetAddress"},
													{oldName:"CITY, STATE", newName:"citystate"}, {oldName:"COUNTRY", newName:"country"}, {oldName:"HOME_PAGE", newName:"homepage", object:"presence"},
